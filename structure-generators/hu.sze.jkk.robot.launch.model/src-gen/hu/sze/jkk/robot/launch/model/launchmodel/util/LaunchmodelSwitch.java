 ...
 * @generated
 */
public class LaunchmodelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case LaunchmodelPackage.STATIC_TRANSFORM: {
			StaticTransform staticTransform = (StaticTransform) theEObject;
			T result = caseStaticTransform(staticTransform);
			if (result == null)
				result = caseNode(staticTransform);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LaunchmodelPackage.VEC3: {
			Vec3 vec3 = (Vec3) theEObject;
			T result = caseVec3(vec3);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Static Transform</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Static Transform</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStaticTransform(StaticTransform object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Vec3</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Vec3</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseVec3(Vec3 object) {
		return null;
	}
