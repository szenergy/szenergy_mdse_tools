...
public class KinematicTreeGenerator {
	...
	public void generateKinematicTreeToFile(Resource resource, String filename) throws FileNotFoundException{
	    ...
	    VehicleConfigToKinematicTree transformation;
		...
		transformation = new VehicleConfigToKinematicTree(robot, engine);
		...
		Document doc = transformation.getDocument();
	    ...
	    */
	    transformation.writeDocumentToText(new PrintStream(new File(filename)));
	    engine.dispose();
	}
}
