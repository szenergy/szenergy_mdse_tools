...
public class StatepubsubmodelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case StatepubsubmodelPackage.MIDDLEWARE_NETWORK: {
			MiddlewareNetwork middlewareNetwork = (MiddlewareNetwork) theEObject;
			T result = caseMiddlewareNetwork(middlewareNetwork);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Middleware Network</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Middleware Network</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMiddlewareNetwork(MiddlewareNetwork object) {
		return null;
	}
